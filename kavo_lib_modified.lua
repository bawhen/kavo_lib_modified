        ...
        coroutine.wrap(function()
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderBtn.InputBegan:Connect(function(input)
                    if not focusing and input.UserInputType == Enum.UserInputType.MouseButton1 or not focusing and input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        moveconnection = uis.InputChanged:Connect(function(input1)
